...
<body>
<form action="<%=path%>/updateCourses">
    <div class="row">
        ...
        <div class="col-lg-6" style="text-align: center;margin: auto">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <input name="coursesid" type="hidden" value="${courses.coursesid}"/>
                        <input type="text" name="coursesname" placeholder="输入名字" value="${courses.coursesname}"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="term" placeholder="输入学期" value="${courses.term}"/></td>
                </tr>
                <tr>
                    <td style="float: left">学分：</td>
                    <td><input type="text" name="cost" placeholder="输入学分" value="${courses.cost}"/></td>
                </tr>
                <tr>
                    <td>
