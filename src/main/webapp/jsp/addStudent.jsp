...
<body>
<form action="<%=path%>/insertStudent">
    <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-6" style="text-align: center;margin: auto">
            <table class="table table-striped">
                <tr>
                    <td style="font-size: 30px" colspan="2"><b>添加学生</b></td>
                </tr>
                <tr>
                    <td style="float: left">学生名：</td>
                    <td><input style="width: 100%" type="text" name="studentname" placeholder="输入名字"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input style="width: 100%" type="text" name="intime" placeholder="输入入学时间,格式为XXXX-XX"/></td>
                </tr>
                <tr>
                    <td style="float: left">出生年月：</td>
                    <td><input style="width: 100%" type="text" name="birthday" placeholder="输入出生年月日，格式为XXXX-XX-XX"/></td>
                </tr>
                <tr>
